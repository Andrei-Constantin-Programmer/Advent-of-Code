...
{
    class ChallengeSolution7 : ChallengeSolution
    {
        ...
        {
            List<int> initialPositions = new List<int>(Array.ConvertAll(Utilities.GetInputFile(2021, 7).ReadLine().Split(",", StringSplitOptions.RemoveEmptyEntries), int.Parse));

...
open Xunit
open Advent_of_Code.FSharp.Challenge_Solutions.Year_2025.ChallengeSolution02
open Advent_of_Code.FSharp.Tests.TestUtilities
open TestExtensions

module ChallengeSolutionTests02 =
    ...
    let getRealInput() : string list = TestHelpers.GetInputFileContents(2025, 2) |> List.ofArray
    ...
    let ``SolveFirstPart with sample input`` () =
        ...
        // Assert
        writeLineFake.VerifyCalledContainingLong 1227775554 1
    ...
    let ``SolveFirstPart with real input``() =
        ...
        // Assert
        writeLineFake.VerifyCalledContainingLong 18893502033L 1        
    ...
    let ``SolveSecondPart with sample input`` () =
        ...
        // Assert
        writeLineFake.VerifyCalledContainingLong 4174379265L 1
    ...
    let ``SolveSecondPart with real input``() =
        ...
        // Assert
        writeLineFake.VerifyCalledContainingLong 26202168557L 1       